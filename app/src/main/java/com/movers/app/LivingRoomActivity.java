...
public class LivingRoomActivity extends AppCompatActivity {
    ...
    public void addListenerOnButtonClick(){
        ...
        woofer = findViewById(R.id.wooferCheckBox);
        ...
        submitLivingRoom.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(tv.isChecked()){
                    ...
                    totalCost += 1000;
                }else if(sofa.isChecked()){
                    result.append("Sofa : 1000");
                    totalCost += 1000;
                }else if(table.isChecked()){
                    result.append("Table : 1000");
                    totalCost += 1000;
                }else if (woofer.isChecked()){
                    result.append("Woofer : 500");
                    totalCost += 500;
                }else if(!tv.isChecked() && !sofa.isChecked() && !table.isChecked() && !woofer.isChecked()){
                    Toast.makeText(LivingRoomActivity.this,"Please select an item to move",Toast.LENGTH_LONG).show();
                }
                Toast.makeText(LivingRoomActivity.this, "Inventory added successfully",Toast.LENGTH_LONG).show();
                Intent intent = new Intent(LivingRoomActivity.this, Inventory.class);
                intent.putExtra("LivingRoomCost",totalCost);
