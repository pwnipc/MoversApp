...
public class BookingActivity extends AppCompatActivity {
    ...
    private static final String API_KEY = "AIzaSyBvkWPOy49fuHFIpSSL4jpAeWmKz-pkvkQ";
    EditText search;
    ...
    public class GooglePlaces extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                ...
                String strURL = PLACES_API_BASE+TYPE_AUTOCOMPLETE+OUT_JSON+key+input;
    ...
    public void setAdapter() {
        GooglePlaceAdapter adapter = new GooglePlaceAdapter(BookingActivity.this, googlePlaceModels);
